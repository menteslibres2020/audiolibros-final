...
import { GeneratedImage } from '../typesImage';
...
const ImageResult: React.FC<ImageResultProps> = ({ image, isGenerating, isDark }) => {
  if (isGenerating) {
    return (
      <div className="w-full min-h-[550px] bg-[#fdfaff] dark:bg-slate-900 flex flex-col items-center justify-center relative overflow-hidden transition-all duration-500 rounded-[3rem]">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-50/50 via-white to-purple-50/50 dark:from-indigo-900/20 dark:via-slate-900 dark:to-purple-900/20 animate-pulse"></div>
        <div className="relative flex flex-col items-center z-10">
          <div className="w-24 h-24 relative mb-12">
            <div className="absolute inset-0 border-[6px] border-purple-100 dark:border-purple-900 rounded-full"></div>
            <div className="absolute inset-0 border-[6px] border-indigo-500 rounded-full border-t-transparent animate-spin"></div>
            <div className="absolute inset-4 border-[4px] border-purple-200 dark:border-purple-800 rounded-full border-b-transparent animate-[spin_1.5s_linear_infinite_reverse]"></div>
          </div>
          <div className="flex flex-col items-center gap-2">
            <p className="text-[13px] font-black uppercase tracking-[0.6em] text-indigo-600 dark:text-indigo-400 animate-pulse text-center px-4">
              Esculpiendo Arte
            </p>
        ...
        <div className="absolute top-10 left-10 w-32 h-32 bg-purple-100/30 dark:bg-purple-900/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-10 w-40 h-40 bg-indigo-100/30 dark:bg-indigo-900/20 rounded-full blur-3xl"></div>
      </div>
    );
  }
  ...
  if (!image) {
    return (
      <div className="w-full min-h-[550px] bg-[#fafbfc] dark:bg-slate-900 flex flex-col items-center justify-center p-20 text-center rounded-[3rem]">
        <div className="w-24 h-24 border-2 border-dashed border-gray-200 dark:border-slate-700 rounded-[2.8rem] flex items-center justify-center text-gray-200 dark:text-slate-600 mb-8 bg-white dark:bg-slate-800 shadow-sm transition-all duration-500">
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.5em] text-gray-300 dark:text-slate-500">Esperando Inspiración</p>
      </div>
    );
  }
  ...
  return (
    <div className="relative group bg-neutral-950 overflow-hidden shadow-2xl transition-all duration-700 ease-in-out min-h-[550px] flex items-center justify-center rounded-[3rem]">
